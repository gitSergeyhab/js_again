...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.no_click', '.js-slide', 'after_click');
...
var modals = function modals() {
  var bindModal = function bindModal(btnOpenSelector, modalSelector, btnCloseSelector) {
    var openBtns = document.querySelectorAll(btnOpenSelector);
    var modal = document.querySelector(modalSelector); // const closeBtn = modal.querySelector(btnCloseSelector);
  ...
  var timeoutModal = function timeoutModal(modalSelector, time) {
    setTimeout(function () {
  ...
  bindModal('.phone_link', '.popup', '.popup_close'); // timeoutModal('.popup_engineer', 2000);
};
...
var tabs = function tabs(tabSelector, slideSelector, classActive) {
  var tabList = document.querySelectorAll(tabSelector);
  var sliders = document.querySelectorAll(slideSelector);
  tabList.forEach(function (tab, i) {
    tab.addEventListener('click', function () {
      tabList.forEach(function (tabInside) {
        return tabInside.classList.remove(classActive);
      });
